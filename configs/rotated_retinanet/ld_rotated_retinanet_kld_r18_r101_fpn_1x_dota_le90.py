...
teacher_ckpt = '/root/mmrotate/train_alpod/DOTA/other_methods/ld/rotated_retinanet_r101_fpn_1x_dota_le90/latest.pth'
angle_version = 'le90'
model = dict(
    type='KnowledgeDistillationRotatedSingleStageDetector',
    teacher_config='/root/mmrotate/configs/nsd/DOTA/other_methods/ld_rotated_retinanet_r101_fpn_1x_dota_le90.py',

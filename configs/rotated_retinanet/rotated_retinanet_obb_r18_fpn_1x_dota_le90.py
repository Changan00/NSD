...
data = dict(
    train=dict(
        ann_file='/root/data/DOTA/LOSS/annfiles/',
        img_prefix='/root/data/DOTA/LOSS/images/',
        pipeline=train_pipeline, version=angle_version),
    val=dict(version=angle_version),
    test=dict(
        # ann_file='/root/data/DOTA/CMP/annfiles/',
        # img_prefix='/root/data/DOTA/CMP/images/',
        version=angle_version))

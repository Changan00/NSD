...
model = dict(
    ...
    teacher_config='/root/mmrotate/configs/nsd/rotated_retinanet/rotated_retinanet_obb_r101_fpn_1x_dota_le90.py',
    teacher_ckpt='/root/mmrotate/workdirs/rotated_retinanet/rotated_retinanet_obb_r101_fpn_1x_dota_le90/latest.pth',
    output_feature=True,
    fpnkd_cfg=dict(
        feature_kd=True,

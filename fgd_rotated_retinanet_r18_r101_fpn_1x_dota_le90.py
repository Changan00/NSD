_base_ = [
    ...
    '/root/mmrotate/configs/_base_/schedules/schedule_2x.py',
...
model = dict(
    type='FGD',
    teacher_config='/root/mmrotate/configs/nsd/DOTA/baseline/rotated_retinanet/rotated_retinanet_obb_r101_fpn_1x_dota_le90.py',
